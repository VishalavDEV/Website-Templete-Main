...
function AppRoutes({ user, cart, addToCart, removeFromCart, clearCart, handleLogin, handleLogout }) {
  ...
  const isTemplateRoute = 
    ...
    (location.pathname.startsWith('/templates/photography/') && location.pathname !== '/templates/photography') ||
    (location.pathname.startsWith('/templates/portfolio/') && location.pathname !== '/templates/portfolio');
