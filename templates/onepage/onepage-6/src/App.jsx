        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glow-card p-8 rounded-2xl">
              ...
              <h3 className="font-syne text-xl font-bold text-white mb-3">Digital Product Touchpoints</h3>
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
                Editorial websites, high-converting product landing pages, motion graphics, and interactive investor showcases.
              </p>
              <ul className="space-y-2 text-xs text-slate-300 font-medium">
                <li className="flex items-center gap-2"><CheckCircle2 size={14} className="text-amber-400" /> Responsive Web App Design</li>
            ...
            {!formSubmitted ? (
              <>
                ...
                <form onSubmit={(e) => { e.preventDefault(); setFormSubmitted(true); }} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-300 mb-1">Brand Goals</label>
                    <textarea 
                      rows={3} 
                      placeholder="Tell us about your brand vision, launch date, or target rebrand..."
                      className="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-sm text-white focus:border-amber-400 focus:outline-none"
                    ></textarea>
                  </div>
