...
category: { id: 20256, name: 'Business', slug: 'business' },
  ...
  {
    id: 30001,
    name: 'TechnoAdmin — Executive Cyberpunk Admin Dashboard',
    slug: 'admin-10',
    previewImage: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80',
    templateType: 'FREE',
    price: 0,
    ...
    pagesCount: 10,
    downloadsCount: 2150,
    description: 'An executive cyberpunk admin & analytics dashboard template featuring real-time data charts, user management, order timelines, and glassmorphism UI.',
    bootstrapVersion: 'React / Vite / Tailwind CSS',
    version: '1.0.0',
    demoUrl: '/templates/admin/admin-10/index.html',
  },
