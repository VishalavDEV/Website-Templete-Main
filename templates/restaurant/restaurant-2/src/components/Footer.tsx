    ...
    <>
      <footer className="site-footer">
        <div className="container-xl">
          ...
          <div className="footer-bottom-bar flex flex-col md:flex-row items-center justify-between gap-3 text-xs pt-6 mt-8 border-t border-white/10">
            <div className="text-neutral-400">
              © 2026 Ember & Olive Commercial Template. Released under the{' '}
              <button
                type="button"
                onClick={() => setIsLicenseModalOpen(true)}
                className="text-xs text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 underline underline-offset-4 bg-transparent border-0 p-0 cursor-pointer transition-colors"
              >
                MIT License
              </button>
              .
            ...
            <div className="d-flex items-center gap-3">
              <Link to="/license" className="text-xs text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 underline underline-offset-4">
                License Details
              </Link>
