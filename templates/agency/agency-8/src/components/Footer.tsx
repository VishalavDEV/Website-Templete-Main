            ...
            <ul className="space-y-3 font-medium text-sm">
              {socialLinks.map((item) => (
                <li key={item.name}>
                  ...
                  >
                    <span>{item.name}</span>
                    <ArrowUpRight className="w-3.5 h-3.5 text-[#888888] group-hover:text-[#ffffff] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                  </a>
                </li>
              ))}
            </ul>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="space-y-3">
              <a
                ...
                onMouseEnter={() => setCursorType('pointer')}
                onMouseLeave={() => setCursorType('default')}
                className="block text-sm text-[#FAF9F6] hover:text-[#ffffff] transition-colors font-mono"
              >
                hello@studio.com
              </a>
              ...
              >
                {copied ? (
                  <>
                    ...
                    <span className="text-[#ffffff]">Copied to clipboard</span>
                  </>
                ) : (
                  <>
              ...
              <div className="pt-2">
                <button
                  ...
                  onMouseEnter={() => setCursorType('pointer')}
                  onMouseLeave={() => setCursorType('default')}
                  className="px-4 py-2 bg-[#ffffff]/20 hover:bg-[#ffffff]/30 border border-[#ffffff]/40 text-[#ffffff] text-xs font-mono tracking-wider uppercase transition-colors cursor-pointer"
                >
                  Brief Form &nearr;
                </button>
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-[#888888] font-mono border-t border-[#ffffff10] pt-8">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <ArrowUp className="w-3.5 h-3.5 text-[#ffffff]" />
            </button>
          </div>
        </div>
      </div>
