  ...
  return (
    <section className="border-t border-white/10 bg-[#080808]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10">
        ...
        >
          <div className="flex items-center gap-2 text-[#888888] font-mono text-xs uppercase tracking-widest group-hover:text-[#ffffff] transition-colors">
          ...
          <div className="space-y-2">
            ...
            <h3 className="font-display font-extrabold text-xl sm:text-2xl lg:text-3xl text-[#FAF9F6] uppercase tracking-tight group-hover:text-[#ffffff] transition-colors leading-tight">
              {previous.title}
            </h3>
          </div>
        </div>
        ...
        >
          <div className="flex items-center md:justify-end gap-2 text-[#888888] font-mono text-xs uppercase tracking-widest group-hover:text-[#ffffff] transition-colors">
