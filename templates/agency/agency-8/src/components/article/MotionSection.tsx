              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 transition-all duration-300 border cursor-pointer ${
                    isSelected
                      ? 'bg-[#6366f1]/10 border-[#6366f1] text-[#FAF9F6]'
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight
                      className={`w-3.5 h-3.5 transition-transform duration-300 ${
                        isSelected ? 'translate-x-1 text-[#6366f1]' : 'opacity-40'
                      }`}
                    />
                  </div>
                  <p className="font-mono text-[10px] text-[#6366f1] tracking-wider mt-1 uppercase">
                    {rule.subtitle}
                  </p>
            ...
            <AnimatePresence mode="wait">
              {activeStep === 0 && (
                <motion.div
                  ...
                  className="w-full max-w-xs p-6 bg-[#111116] border border-[#6366f1]/40 space-y-4 shadow-2xl relative z-10"
                >
                  <div className="flex items-center justify-between border-b border-white/10 pb-3">
                    <span className="font-mono text-[10px] text-[#6366f1] uppercase tracking-widest font-bold">
                      STATE ACCELERATION
                    </span>
              ...
              {activeStep === 2 && (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-[#6366f1]/20 border border-[#6366f1] flex items-center justify-center mx-auto text-[#6366f1]">
