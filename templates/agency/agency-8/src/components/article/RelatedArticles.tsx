            ...
            return (
              ...
              >
                ...
                <div className="w-full h-[240px] sm:h-[280px] overflow-hidden border border-white/10 relative bg-[#0e0e12]">
                  ...
                  <div className="absolute top-4 left-4 px-2 py-0.5 bg-black/60 border border-white/10 font-mono text-[9px] uppercase tracking-widest text-[#6366f1]">
                    {article.category}
                  </div>
                </div>
                ...
                <div className="space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-2">
                    <h3 className="font-display font-bold text-lg sm:text-xl text-[#FAF9F6] uppercase tracking-tight group-hover:text-[#6366f1] transition-colors leading-snug">
                      {article.title}
                    </h3>
                  ...
                  <div className="pt-4 border-t border-white/10 flex items-center justify-between font-mono text-[10px] text-[#666666]">
                    ...
                    <div className="flex items-center gap-1 text-[#FAF9F6] group-hover:text-[#6366f1] transition-colors font-semibold uppercase">
