        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="flex items-center gap-2 truncate">
              <span className="text-[#ffffff] font-bold">{activeItem?.number}</span>
            ...
            <div className="flex items-center gap-1 text-[#888888] shrink-0 pl-2">
              ...
              <ChevronDown
                className={`w-3.5 h-3.5 transition-transform duration-300 ${
                  isMobileMenuOpen ? 'rotate-180 text-[#ffffff]' : ''
                }`}
              />
            </div>
          </button>
                    ...
                    <li key={item.id}>
                      <button
                        ...
                        className={`flex items-center justify-between w-full py-1 text-xs font-mono uppercase tracking-wider text-left ${
                          isActive ? 'text-[#ffffff] font-bold' : 'text-[#888888]'
                        }`}
                      >
                        <span className="flex items-center gap-3">
                          <span className={isActive ? 'text-[#ffffff]' : 'text-white/30'}>
                            {item.number}
                          </span>
