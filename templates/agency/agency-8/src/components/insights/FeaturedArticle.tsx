    ...
    <section className="py-20 sm:py-32 px-6 sm:px-8 lg:px-12 bg-[#060608] border-b border-[#ffffff10] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between gap-4 mb-12 sm:mb-16 pb-6 border-b border-[#ffffff10]">
          ...
          <span className="font-mono text-xs text-[#6366f1] uppercase tracking-widest hidden sm:inline flex items-center gap-1.5">
        ...
        <div className="space-y-12 lg:space-y-16">
          ...
          >
            ...
            <div className="absolute inset-0 bg-[#6366f1]/[0.06] mix-blend-screen opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            ...
            <div className="absolute bottom-6 right-6 font-mono text-[10px] uppercase tracking-widest text-[#6366f1] bg-black/70 backdrop-blur-md px-3.5 py-1.5 border border-[#6366f1]/30 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-3 space-y-4 font-mono text-xs border-l-2 border-[#6366f1] pl-4">
              <div className="text-[#6366f1] font-bold uppercase tracking-[0.2em]">
                {article.category}
              </div>
            ...
            <div className="lg:col-span-3 lg:flex lg:justify-end pt-2">
              <button
                ...
                onMouseLeave={() => setCursorType('default')}
                className="group w-full sm:w-auto inline-flex items-center justify-between sm:justify-start gap-4 px-6 py-4 bg-white/[0.03] hover:bg-[#6366f1] text-[#FAF9F6] hover:text-white font-mono text-xs uppercase tracking-widest border border-white/10 hover:border-[#6366f1] transition-all duration-300 cursor-pointer"
              >
