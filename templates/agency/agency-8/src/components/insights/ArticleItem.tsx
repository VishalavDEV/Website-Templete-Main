    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
        ...
        <div className="lg:col-span-3 flex lg:flex-col justify-between items-baseline lg:items-start gap-4">
          ...
          <span className="font-mono text-xs uppercase tracking-[0.2em] text-[#ffffff] font-semibold">
            {article.category}
          </span>
        </div>
        ...
        <div className="lg:col-span-6 space-y-3">
          <h3 className="font-display font-extrabold text-2xl sm:text-3xl lg:text-4xl text-[#FAF9F6] uppercase tracking-tight leading-[1.08] group-hover:text-[#ffffff] group-hover:translate-x-1 sm:group-hover:translate-x-2 transition-all duration-300">
            {article.title}
          </h3>
