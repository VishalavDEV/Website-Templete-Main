      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-block px-3 py-1 bg-white/[0.04] border border-white/10 font-mono text-[10px] uppercase tracking-widest text-[#ffffff]">
              FROM THE ARCHIVE
            </div>
            ...
            <div className="pt-4 flex flex-wrap items-center gap-6 font-mono text-xs text-[#888888]">
              <span className="text-[#ffffff] font-semibold uppercase tracking-widest">
                {article.category}
              </span>
            ...
            <div className="pt-4">
              <button
                ...
                onMouseLeave={() => setCursorType('default')}
                className="group inline-flex items-center gap-4 px-8 py-4 bg-white/[0.03] hover:bg-[#ffffff] text-[#FAF9F6] hover:text-white font-mono text-xs uppercase tracking-widest border border-white/10 hover:border-[#ffffff] transition-all duration-300 cursor-pointer"
              >
