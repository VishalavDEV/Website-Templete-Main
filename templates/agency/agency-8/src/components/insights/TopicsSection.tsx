              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <div className="flex items-baseline gap-4 sm:gap-6">
                    <span className="font-mono text-xs sm:text-sm text-[#555555] group-hover:text-[#10b981] transition-colors">
                      /{formattedIndex}
                    </span>
                  ...
                  <div className="flex items-center justify-between lg:justify-end gap-6 sm:gap-8 font-mono text-xs">
                    <div className="text-left lg:text-right hidden sm:block">
                      ...
                      <div className="text-[#10b981] text-[11px] tracking-widest uppercase mt-0.5">
                        {topic.articleCount} ESSAYS IN ARCHIVE
                      </div>
                    </div>

                    <div className="w-10 h-10 rounded-full border border-white/10 group-hover:border-[#10b981] group-hover:bg-[#10b981] flex items-center justify-center text-white/40 group-hover:text-white transition-all duration-300">
