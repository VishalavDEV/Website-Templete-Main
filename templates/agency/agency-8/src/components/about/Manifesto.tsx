...
export const Manifesto: React.FC = () => {
  return (
    <section className="py-36 sm:py-56 border-t border-[#ffffff10] bg-[#080808] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#10b981]/[0.035] rounded-full blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 text-center">
        ...
        <div className="max-w-5xl mx-auto space-y-4 mb-20 sm:mb-28">
          ...
          >
            WE BELIEVE <br />
            DIGITAL SHOULD <br />
            <span className="font-editorial italic font-normal text-[#10b981] tracking-normal lowercase text-[1.08em]">
              feel human.
            </span>
          </motion.h2>
        </div>
