        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
          {CAPABILITIES_DATA.map((cap, idx) => (
            <motion.div
              ...
              className="group relative p-8 sm:p-10 rounded-2xl bg-white/[0.02] hover:bg-white/[0.04] border border-[#ffffff10] hover:border-[#ffffff]/40 transition-all duration-300 cursor-pointer flex flex-col justify-between min-h-[190px]"
            >
              <div className="flex items-start justify-between">
                <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-[#ffffff] font-semibold">
                  {cap.category}
                </span>
                <ArrowUpRight className="w-5 h-5 text-[#888888] group-hover:text-[#ffffff] group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300" />
              </div>
