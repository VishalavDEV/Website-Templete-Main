                ...
                return (
                  <div
                    ...
                    className={`relative p-4 sm:p-5 rounded-xl transition-all duration-300 cursor-pointer group ${
                      isActive
                        ? 'bg-white/[0.04] border border-[#10b981]/40 text-[#FAF9F6]'
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute -left-[31px] top-6 w-3 h-3 rounded-full bg-[#10b981] ring-4 ring-[#10b981]/20"
                      />
                    )}

                    <div className="flex items-center justify-between">
                      <div className="flex items-baseline gap-4">
                        <span className={`font-mono text-xl sm:text-2xl font-bold transition-colors ${isActive ? 'text-[#10b981]' : 'text-[#888888] group-hover:text-[#FAF9F6]'}`}>
                          {item.year}
                        </span>
                      ...
                      <ArrowUpRight className={`w-4 h-4 transition-transform duration-300 ${isActive ? 'text-[#10b981] rotate-45' : 'text-[#888888] group-hover:text-[#FAF9F6]'}`} />
                    </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <span className="text-xs font-mono uppercase tracking-[0.25em] text-[#10b981] font-semibold">
                ...
                <div className="pt-6 border-t border-[#ffffff10] flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs font-mono">
                  ...
                  <div className="text-[#10b981] font-bold tracking-wider uppercase">
