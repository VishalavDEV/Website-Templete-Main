              ...
              >
                <div className="flex items-start lg:items-center justify-between gap-8">
                  ...
                  <div className="flex items-baseline gap-8 lg:gap-16">
                    <span className="font-mono text-xs tracking-widest text-[#888888] group-hover:text-[#6366f1] group-hover:-translate-x-1 transition-all duration-300">
                      {val.number}
                    </span>
                  ...
                  <div className="max-w-md hidden lg:block">
                    <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-[#6366f1] block mb-1 font-semibold opacity-80 group-hover:opacity-100">
                      {val.tagline}
                    </span>
                  ...
                  {/* Indicator Arrow */}
                  <div className="w-12 h-12 rounded-full border border-[#ffffff15] flex items-center justify-center group-hover:border-[#6366f1] group-hover:bg-[#6366f1]/10 transition-all duration-300 shrink-0">
              ...
              <div key={val.id} className="py-6">
                ...
                >
                  <div className="flex items-center gap-4">
                    <span className="font-mono text-xs text-[#6366f1]">{val.number}</span>
          ...
          {hoveredValue && (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex items-end p-4">
                <div>
                  <span className="text-[10px] font-mono text-[#6366f1] uppercase tracking-widest block font-bold">
