...
export const AboutIntro: React.FC = () => {
  return (
    <section className="py-32 sm:py-48 border-t border-[#ffffff10] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[500px] bg-[#10b981]/[0.025] rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <motion.div
          ...
          className="w-full h-px bg-gradient-to-r from-transparent via-[#10b981]/60 to-transparent origin-left my-16 sm:my-28"
        />
