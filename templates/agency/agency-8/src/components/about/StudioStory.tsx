...
export const StudioStory: React.FC<StudioStoryProps> = ({ setCursorType }) => {
  return (
    <section className="py-28 sm:py-40 border-t border-[#ffffff10] relative overflow-hidden bg-[#080808]">
      ...
      <div className="absolute top-1/3 right-0 w-[550px] h-[550px] bg-[#ffffff]/[0.02] rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-10">
            ...
            >
              <div>
                <span className="text-[#ffffff] block font-bold mb-1">DISCIPLINE</span>
                <span>Interdisciplinary Digital Practice</span>
              </div>
              <div>
                <span className="text-[#ffffff] block font-bold mb-1">FOUNDED</span>
