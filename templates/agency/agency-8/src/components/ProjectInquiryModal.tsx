    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      >
        ...
        {submitted ? (
          ...
          >
            <div className="w-16 h-16 rounded-full bg-[#10b981]/20 border border-[#10b981]/40 text-[#10b981] flex items-center justify-center mx-auto">
            ...
            <button
              onClick={handleReset}
              className="px-6 py-3.5 bg-[#10b981] hover:brightness-110 text-white font-bold text-xs uppercase tracking-wider transition-colors cursor-pointer"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-[#10b981] text-xs font-mono uppercase tracking-[0.25em] font-semibold">
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 text-xs font-mono uppercase tracking-wider transition-all cursor-pointer ${
                        isSelected
                          ? 'bg-[#10b981] text-white font-bold border border-[#10b981]'
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/[0.03] border border-[#ffffff15] text-[#FAF9F6] placeholder-[#555555] text-sm focus:outline-hidden focus:border-[#10b981] transition-colors font-mono"
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-[11px] font-mono uppercase tracking-widest text-[#888888]">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-white/[0.03] border border-[#ffffff15] text-[#FAF9F6] placeholder-[#555555] text-sm focus:outline-hidden focus:border-[#10b981] transition-colors resize-none font-mono"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-4 bg-[#10b981] hover:brightness-110 text-white font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer"
            >
