  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
        <div className="w-96 h-96 rounded-full bg-[#6366f1]/10 blur-[120px]" />
      </div>
      ...
      <div className="relative inline-flex items-center justify-center">
        <motion.div
          ...
          className="absolute inset-0 -m-4 rounded-full border border-[#6366f1]/40"
        />
        <div className="w-20 h-20 rounded-full bg-[#6366f1]/20 border border-[#6366f1] flex items-center justify-center text-[#6366f1]">
      ...
      <div className="space-y-3">
        <div className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-[0.3em] text-[#6366f1]">
        ...
        <h2 className="font-display text-4xl sm:text-6xl md:text-7xl font-black uppercase tracking-tight text-[#FAF9F6] leading-[0.95]">
          THANK YOU. <br />
          <span className="text-[#6366f1]">WE'LL BE IN TOUCH.</span>
        </h2>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
        <MagneticButton
          ...
          className="group inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-mono text-xs uppercase tracking-widest font-bold hover:bg-[#6366f1] hover:text-white transition-all duration-300 cursor-pointer shadow-xl"
        >
