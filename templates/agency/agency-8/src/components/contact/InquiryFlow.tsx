        ...
        {!isSubmitted && (
          <div className="space-y-10 mb-12">
            ...
            <div className="space-y-4 border-b border-[#ffffff15] pb-10">
              <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-[0.3em] text-[#ffffff]">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg font-mono text-xs uppercase tracking-wider transition-all duration-300 ${
                      isCurrent
                        ...
                        : isCompleted
                        ? 'text-[#ffffff] hover:text-white cursor-pointer'
                  ...
                  >
                    <span className="w-4 h-4 rounded-full flex items-center justify-center text-[10px] bg-white/5 border border-white/10">
                      {isCompleted ? <Check className="w-2.5 h-2.5 text-[#ffffff]" /> : stepNum}
                    </span>
            ...
            >
              <div className="space-y-6">
                <div className="space-y-2">
                  <span className="font-mono text-xs uppercase tracking-[0.3em] text-[#ffffff]">
