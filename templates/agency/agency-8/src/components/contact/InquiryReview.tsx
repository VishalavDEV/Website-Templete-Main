    ...
    <div className="space-y-10 pt-2">
      ...
      <div className="p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-white/[0.02] border border-[#ffffff15] space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-6">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-mono uppercase tracking-widest text-[#6366f1] hover:text-white transition-colors cursor-pointer"
          >
          ...
          <div className="space-y-2 p-4 rounded-xl bg-white/[0.02] border border-white/5">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => onEdit(1)}
                className="text-[10px] font-mono text-[#6366f1] hover:underline cursor-pointer"
              >
                EDIT
              </button>
            </div>
            <div className="flex flex-wrap gap-1.5 pt-1">
              {formData.services.length > 0 ? (
                formData.services.map((s) => (
                  <span
                    key={s}
                    className="px-2.5 py-0.5 rounded-full text-xs font-mono bg-[#6366f1]/15 text-[#6366f1] border border-[#6366f1]/30"
                  >
                    {s}
                  </span>
                ))
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4">
        ...
        <MagneticButton
          ...
          className="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-[#6366f1] hover:bg-white text-white hover:text-black font-mono text-xs sm:text-sm uppercase tracking-widest font-bold rounded-full transition-all duration-300 shadow-2xl shadow-[#6366f1]/30 cursor-pointer"
        >
