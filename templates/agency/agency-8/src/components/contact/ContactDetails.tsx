    ...
    <div className="space-y-6 pt-2">
          ...
          <input
            ...
            className={`w-full px-5 py-4 rounded-xl bg-white/[0.03] border text-[#FAF9F6] placeholder-[#888888]/60 focus:outline-none transition-all duration-300 ${
              errors.name
                ...
                : 'border-white/15 focus:border-[#ffffff] focus:bg-white/[0.06]'
            }`}
          />
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          >
            <Building className="w-3.5 h-3.5 text-[#ffffff]" />
          ...
          <input
            ...
            onFocus={() => setCursorType('text')}
            onBlur={() => setCursorType('default')}
            className="w-full px-5 py-4 rounded-xl bg-white/[0.03] border border-white/15 text-[#FAF9F6] placeholder-[#888888]/60 focus:outline-none focus:border-[#ffffff] focus:bg-white/[0.06] transition-all duration-300"
          />
        </div>
      ...
      <div className="space-y-2">
        ...
        >
          <span className="flex items-center gap-1.5">
            <MessageSquare className="w-3.5 h-3.5 text-[#ffffff]" />
