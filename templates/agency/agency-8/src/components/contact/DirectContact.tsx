        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="font-display text-4xl sm:text-6xl font-black uppercase tracking-tight text-[#FAF9F6] leading-[0.95]">
              PREFER TO TALK <br />
              <span className="text-[#10b981]">DIRECTLY?</span>
            </h2>
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-[#ffffff15] space-y-4 relative group hover:border-white/30 transition-all duration-300">
              ...
              <div className="space-y-1">
                <a
                  ...
                  className="font-display text-xl sm:text-2xl font-bold text-[#FAF9F6] hover:text-[#10b981] transition-colors block cursor-pointer"
                >
                  hello@studio.com
                </a>
              ...
              <div className="flex flex-col space-y-2 font-mono text-xs">
                {socials.map((soc) => (
                  <a
                    ...
                    onMouseLeave={() => setCursorType('default')}
                    className="flex items-center justify-between py-1 text-[#FAF9F6] hover:text-[#10b981] border-b border-white/5 last:border-0 transition-colors cursor-pointer"
                  >
                    <span>{soc.name}</span>
