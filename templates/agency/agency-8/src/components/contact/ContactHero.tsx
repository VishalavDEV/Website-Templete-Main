...
export const ContactHero: React.FC<ContactHeroProps> = ({
  ...
  return (
    <section className="relative min-h-[85vh] sm:min-h-[90vh] pt-32 pb-16 flex flex-col justify-between overflow-hidden bg-[#080808]">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] rounded-full blur-[200px] pointer-events-none opacity-20 bg-[#ffffff]" />
      ...
      >
        <button
          ...
          className="inline-flex items-center gap-2 text-[#FAF9F6] hover:text-[#ffffff] transition-colors cursor-pointer"
        >
          <ArrowDown className="w-3.5 h-3.5 animate-bounce text-[#ffffff]" />
