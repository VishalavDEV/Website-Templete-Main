...
export const ServicesPreview: React.FC<ServicesPreviewProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 right-0 w-[500px] h-[500px] bg-[#ffffff]/[0.03] rounded-full blur-[140px] pointer-events-none" />
              ...
              >
                <div className="flex items-start lg:items-center justify-between gap-8">
                  ...
                  <div className="flex items-baseline gap-8 lg:gap-16">
                    <span className="font-mono text-xs tracking-widest text-[#888888] group-hover:text-[#ffffff] transition-colors duration-300">
                      {service.number}
                    </span>
                  ...
                  <div className="max-w-md hidden lg:block">
                    <p className="text-xs uppercase tracking-widest text-[#ffffff] font-mono mb-1.5 opacity-80 group-hover:opacity-100 transition-opacity">
                      {service.tagline}
                    </p>
                  ...
                  <div className="flex items-center justify-center w-14 h-14 rounded-full border border-[#ffffff15] group-hover:border-[#ffffff] group-hover:bg-[#ffffff]/10 transition-all duration-300 shrink-0">
              ...
              <div key={service.id} className="py-6">
                ...
                >
                  <div className="flex items-center gap-4">
                    <span className="font-mono text-xs text-[#ffffff]">{service.number}</span>
                ...
                <AnimatePresence>
                  {isExpanded && (
                    ...
                    >
                      ...
                      <p className="text-xs uppercase font-mono tracking-wider text-[#ffffff]">
                        {service.tagline}
                      </p>
        ...
        {hoveredService && (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent flex items-end p-4">
              <div>
                <span className="text-[10px] font-mono text-[#ffffff] uppercase tracking-widest">
