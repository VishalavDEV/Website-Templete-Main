...
export const ServicesPreview: React.FC<ServicesPreviewProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 right-0 w-[500px] h-[500px] bg-[#10b981]/[0.03] rounded-full blur-[140px] pointer-events-none" />
              ...
              >
                <div className="flex items-start lg:items-center justify-between gap-8">
                  ...
                  <div className="flex items-baseline gap-8 lg:gap-16">
                    <span className="font-mono text-xs tracking-widest text-[#888888] group-hover:text-[#10b981] transition-colors duration-300">
                      {service.number}
                    </span>
                  ...
                  <div className="max-w-md hidden lg:block">
                    <p className="text-xs uppercase tracking-widest text-[#10b981] font-mono mb-1.5 opacity-80 group-hover:opacity-100 transition-opacity">
                      {service.tagline}
                    </p>
                  ...
                  <div className="flex items-center justify-center w-14 h-14 rounded-full border border-[#ffffff15] group-hover:border-[#10b981] group-hover:bg-[#10b981]/10 transition-all duration-300 shrink-0">
              ...
              <div key={service.id} className="py-6">
                ...
                >
                  <div className="flex items-center gap-4">
                    <span className="font-mono text-xs text-[#10b981]">{service.number}</span>
                ...
                <AnimatePresence>
                  {isExpanded && (
                    ...
                    >
                      ...
                      <p className="text-xs uppercase font-mono tracking-wider text-[#10b981]">
                        {service.tagline}
                      </p>
