...
export const OpenApplication: React.FC<OpenApplicationProps> = ({
  ...
  return (
    <section className="py-24 sm:py-36 border-b border-white/10 relative overflow-hidden bg-[#080808]">
      ...
      <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[500px] h-[500px] bg-[#ffffff]/[0.025] rounded-full blur-[160px] pointer-events-none" />
        ...
        <div className="p-8 sm:p-16 lg:p-20 bg-[#0C0C10] border border-white/15 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-4 flex lg:justify-end">
            <MagneticButton
              ...
              className="inline-flex items-center gap-3 px-8 py-5 bg-[#FAF9F6] hover:bg-[#ffffff] text-black hover:text-white font-mono text-xs uppercase tracking-widest font-bold border border-white/20 transition-all duration-300 cursor-pointer shadow-xl"
            >
