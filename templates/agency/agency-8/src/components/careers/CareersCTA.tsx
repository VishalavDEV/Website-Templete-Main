...
export const CareersCTA: React.FC<CareersCTAProps> = ({
  ...
  return (
    <section className="py-28 sm:py-40 px-6 sm:px-8 lg:px-12 bg-[#080808] relative overflow-hidden text-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-[#6366f1]/[0.035] rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        ...
        <div className="pt-6">
          <MagneticButton
            ...
            className="inline-flex items-center gap-3 px-10 py-5 bg-[#6366f1] hover:brightness-110 text-white font-mono text-xs uppercase tracking-widest font-bold border border-[#6366f1]/40 transition-all duration-300 cursor-pointer shadow-xl shadow-[#6366f1]/15"
          >
