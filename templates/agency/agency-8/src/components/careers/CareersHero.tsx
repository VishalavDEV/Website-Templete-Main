...
export const CareersHero: React.FC<CareersHeroProps> = ({ setCursorType }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-[#ffffff]/[0.035] rounded-full blur-[140px] pointer-events-none" />
            ...
            {CAREERS_HERO_DATA.headline.map((line, idx) => (
              <span key={line} className="block overflow-hidden">
                <motion.span
                  ...
                  className={`block ${idx === 2 ? 'text-[#ffffff]' : ''}`}
                >
                  {line}
                </motion.span>
              </span>
