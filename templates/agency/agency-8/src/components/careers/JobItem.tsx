  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full text-left py-8 sm:py-12 px-4 sm:px-8 group cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#ffffff] transition-all duration-300"
      >
          ...
          <div className="md:col-span-1 flex items-center justify-end">
            <div
              className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all duration-300 ${
                isExpanded
                  ? 'bg-[#ffffff] border-[#ffffff] text-white rotate-180'
                  : 'bg-white/[0.02] border-white/15 text-[#888888] group-hover:border-[#ffffff] group-hover:text-[#FAF9F6]'
              }`}
            >
        ...
        <AnimatePresence>
          {isHovered && !isExpanded && (
            ...
            >
              ...
              <div className="absolute bottom-2 left-2 font-mono text-[9px] uppercase tracking-widest text-[#ffffff] font-bold">
                VIEW SPECS ↗
              </div>
            </motion.div>
          )}
