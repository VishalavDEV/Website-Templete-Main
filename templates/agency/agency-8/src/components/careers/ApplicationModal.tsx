  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-y-auto">
        ...
        >
          {/* Top ambient glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-80 h-32 bg-[#6366f1]/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="flex items-start justify-between gap-6 pb-6 border-b border-white/10 relative z-10">
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[10px] sm:text-xs uppercase tracking-[0.25em] text-[#6366f1] font-semibold">
                  {roleDept}
                </span>
              </div>
          ...
          <div className="pt-6 relative z-10">
            {!isSuccess ? (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-[#6366f1]/10 border border-[#6366f1]/40 flex items-center justify-center mx-auto text-[#6366f1]">
                ...
                <div className="pt-4">
                  <button
                    ...
                    onMouseEnter={() => setCursorType('button')}
                    onMouseLeave={() => setCursorType('default')}
                    className="px-8 py-4 bg-white/[0.05] hover:bg-[#6366f1] border border-white/20 hover:border-[#6366f1] text-[#FAF9F6] hover:text-white font-mono text-xs uppercase tracking-widest font-bold transition-all cursor-pointer"
                  >
                    CLOSE
                  </button>
                </div>
