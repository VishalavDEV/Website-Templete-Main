        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex items-center justify-between">
                ...
                >
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute inset-0 bg-[#6366f1]/20 border border-[#6366f1]/40 rounded-full -z-10"
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              onMouseLeave={() => setCursorType('default')}
              className="lg:hidden p-2.5 rounded-full bg-white/[0.04] border border-white/15 text-[#FAF9F6] hover:bg-white/10 hover:border-white/30 transition-colors focus:outline-hidden focus:ring-1 focus:ring-[#6366f1] cursor-pointer"
