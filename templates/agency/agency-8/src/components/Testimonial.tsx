...
export const Testimonial: React.FC<TestimonialProps> = ({ setCursorType }) => {
  ...
  return (
    <section className="py-28 sm:py-36 border-t border-[#ffffff10] bg-[#080808] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#10b981]/[0.02] rounded-full blur-[140px] pointer-events-none" />
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#888888] font-mono">
                      {current.role}, <span className="text-[#10b981]">{current.company}</span>
                    </p>
                  </div>
                </div>
