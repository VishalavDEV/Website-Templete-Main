...
export const ServicePhilosophy: React.FC<ServicePhilosophyProps> = ({ service }) => {
  return (
    <section className="py-32 sm:py-48 bg-[#0a0a0a] border-t border-[#ffffff10] px-6 sm:px-8 lg:px-12 relative overflow-hidden text-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#ffffff]/[0.03] rounded-full blur-[200px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto relative z-10 space-y-10">
        ...
        <div className="space-y-2 select-none">
          ...
          <motion.h2
            ...
            className="font-editorial italic font-normal text-[#ffffff] tracking-normal lowercase text-5xl sm:text-7xl md:text-8xl lg:text-9xl leading-[0.95]"
          >
