        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center justify-between">
            <div className="lg:col-span-8 space-y-4">
              ...
              <h2 className="font-display text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black uppercase text-[#FAF9F6] tracking-tight group-hover:text-[#10b981] transition-colors duration-300">
                {next.title}
              </h2>
            ...
            <div className="lg:col-span-4 flex lg:justify-end">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#10b981] group-hover:bg-[#0052cc] text-white flex items-center justify-center transition-all duration-300 shadow-xl group-hover:scale-110">
