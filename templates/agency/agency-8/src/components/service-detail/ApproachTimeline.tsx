...
export const ApproachTimeline: React.FC<ApproachTimelineProps> = ({
  ...
  return (
    <section className="py-32 sm:py-48 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden">
      {/* Glow accent */}
      <div className="absolute top-1/2 left-1/3 w-[600px] h-[600px] bg-[#ffffff]/[0.03] rounded-full blur-[180px] pointer-events-none" />
            ...
            >
              <div className="grid grid-cols-12 gap-10 lg:gap-16 items-start">
                ...
                <div className="col-span-5 space-y-6">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/[0.04] border border-white/10 rounded-full font-mono text-xs text-[#ffffff] uppercase tracking-wider">
        ...
        <div className="md:hidden space-y-8 relative border-l border-white/10 ml-3 pl-6">
          {service.approachSteps.map((step) => (
            <div key={step.number} className="relative space-y-3">
              {/* Timeline Bullet */}
              <div className="absolute -left-[31px] top-1 w-3 h-3 rounded-full bg-[#ffffff] border-2 border-black" />
