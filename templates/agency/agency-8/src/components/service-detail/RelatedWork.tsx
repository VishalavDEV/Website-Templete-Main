                ...
                >
                  ...
                  >
                    <div className="relative aspect-[16/10] w-full rounded-2xl overflow-hidden bg-[#111111] border border-white/10 shadow-2xl">
                      ...
                      {project.metrics && (
                        <div className="absolute top-4 left-4 px-3 py-1 bg-black/70 backdrop-blur-md rounded-full border border-white/15 text-[11px] font-mono text-[#ffffff] uppercase tracking-wider font-semibold">
                          {project.metrics}
                        </div>
                      )}

                      {/* Floating View Badge on Hover */}
                      <div className="absolute bottom-4 right-4 w-11 h-11 rounded-full bg-[#ffffff] text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 shadow-lg">
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <h3 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black uppercase text-[#FAF9F6] tracking-tight group-hover:text-[#ffffff] transition-colors duration-300">
                        {project.title}
                      </h3>
