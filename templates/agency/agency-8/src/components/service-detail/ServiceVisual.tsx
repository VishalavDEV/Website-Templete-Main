    ...
    >
      <div className="max-w-[1440px] mx-auto">
        ...
        >
          ...
          <div className="absolute top-6 left-6 px-3.5 py-1.5 bg-black/70 backdrop-blur-md rounded-full border border-white/15 text-xs font-mono text-[#10b981] uppercase tracking-widest pointer-events-none font-semibold">
