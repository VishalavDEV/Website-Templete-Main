...
export const ServiceDetailHero: React.FC<ServiceDetailHeroProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-10 w-[600px] h-[600px] bg-[#ffffff]/[0.05] rounded-full blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 my-auto">
        ...
        >
          ...
          <span className="font-mono text-xs sm:text-sm uppercase tracking-[0.35em] text-[#ffffff] font-bold">
            {service.badge}
          </span>
          ...
          <div className="lg:col-span-7 space-y-8 sm:space-y-10">
            <div className="space-y-1 select-none">
              ...
              <div className="overflow-hidden">
                <motion.h1
                  ...
                  className="font-editorial italic font-normal text-[#ffffff] tracking-normal lowercase text-5xl sm:text-7xl md:text-8xl lg:text-9xl leading-[0.92]"
                >
            ...
            >
              <MagneticButton
                ...
                className="group inline-flex items-center gap-3 px-8 py-4 bg-[#ffffff] hover:bg-[#0055dd] text-white font-bold text-xs uppercase tracking-widest transition-all duration-300 rounded-full shadow-lg shadow-[#ffffff]/20"
              >
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/60 backdrop-blur-md border border-white/10 rounded-xl flex items-center justify-between pointer-events-none">
                <div>
                  <span className="font-mono text-[10px] uppercase tracking-widest text-[#ffffff] block font-bold">
                    CAPABILITY FOCUS
                  </span>
      ...
      <div className="max-w-7xl mx-auto w-full pt-12 border-t border-white/10 flex items-center justify-between font-mono text-xs text-[#666666] uppercase tracking-widest">
        ...
        <span className="text-[#ffffff]">CAPABILITY CASE STUDY</span>
      </div>
    </section>
  );
};
