        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
          {service.impactStats.map((stat, idx) => (
            <motion.div
              ...
              className="p-8 sm:p-10 rounded-2xl bg-white/[0.02] border border-white/[0.08] relative overflow-hidden group hover:border-[#6366f1]/40 transition-colors"
            >
              <div className="space-y-4">
                <span className="font-mono text-xs text-[#6366f1] block font-bold">
                  METRIC // 0{idx + 1}
                </span>
