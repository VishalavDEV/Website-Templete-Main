...
export const JoinStudio: React.FC<JoinStudioProps> = ({ setCursorType, onNavigate }) => {
  ...
  return (
    <section className="py-24 sm:py-36 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/3 w-[500px] h-[500px] bg-[#ffffff]/[0.025] rounded-full blur-[180px] pointer-events-none" />
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            >
              <button
                ...
                className="group inline-flex items-center gap-3 px-7 py-4 bg-[#FAF9F6] hover:bg-[#ffffff] text-black hover:text-white text-xs font-mono uppercase tracking-widest font-bold rounded-full transition-all duration-300 shadow-lg cursor-pointer"
              >
            ...
            {openRoles.map((role) => (
              ...
              >
                <div className="space-y-1">
                  <h3 className="font-display text-xl font-bold uppercase tracking-tight text-[#FAF9F6] group-hover:text-[#ffffff] transition-colors">
                    {role.title}
                  </h3>
                ...
                <div
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/70 group-hover:bg-[#ffffff] group-hover:border-[#ffffff] group-hover:text-white transition-all"
                >
