...
export const TeamCulture: React.FC<TeamCultureProps> = ({ setCursorType }) => {
  return (
    <section className="py-24 sm:py-36 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/3 w-[600px] h-[600px] bg-[#10b981]/[0.02] rounded-full blur-[180px] pointer-events-none" />
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 space-y-2 pointer-events-none mt-40 sm:mt-48">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-mono tracking-widest uppercase bg-black/60 backdrop-blur-md text-[#10b981] border border-white/10 inline-block font-bold">
                    {item.tag}
                  </span>
