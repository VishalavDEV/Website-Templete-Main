...
export const TeamCTA: React.FC<TeamCTAProps> = ({ onOpenProjectModal, setCursorType }) => {
  return (
    <section className="py-28 sm:py-44 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden text-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[550px] bg-[#6366f1]/[0.04] rounded-full blur-[200px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 space-y-10">
        ...
        >
          <MagneticButton
            ...
            className="group inline-flex items-center gap-3 px-8 sm:px-10 py-4 sm:py-5 bg-[#6366f1] hover:bg-white text-white hover:text-black font-mono text-xs sm:text-sm uppercase tracking-widest font-bold rounded-full transition-all duration-300 shadow-2xl shadow-[#6366f1]/30 cursor-pointer"
          >
