...
export const TeamDisciplines: React.FC<TeamDisciplinesProps> = ({ setCursorType }) => {
  ...
  return (
    <section className="py-24 sm:py-36 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] bg-[#6366f1]/[0.025] rounded-full blur-[180px] pointer-events-none" />
              ...
              return (
                <div
                  ...
                  className={`group py-6 sm:py-8 border-b border-[#ffffff15] transition-all duration-300 cursor-pointer flex items-center justify-between ${
                    isSelected ? 'opacity-100 pl-4 border-[#6366f1]/40' : 'opacity-40 hover:opacity-80'
                  }`}
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className={`w-7 h-7 rounded-full flex items-center justify-center border transition-all duration-300 ${
                        isSelected
                          ? 'bg-[#6366f1] border-[#6366f1] text-white rotate-45'
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative aspect-[16/10] rounded-xl overflow-hidden border border-white/10 bg-[#111115]">
                  ...
                  <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/15 text-[10px] font-mono tracking-widest text-[#6366f1] uppercase">
                ...
                <div className="space-y-3">
                  <span className="font-mono text-xs text-[#6366f1] tracking-widest uppercase font-bold block">
