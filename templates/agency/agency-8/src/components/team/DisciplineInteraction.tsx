...
export const DisciplineInteraction: React.FC<DisciplineInteractionProps> = ({ setCursorType }) => {
  ...
  return (
    <section className="py-24 sm:py-36 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden">
      {/* Radial glow */}
      <div className="absolute top-1/2 right-1/4 w-[600px] h-[600px] bg-[#10b981]/[0.025] rounded-full blur-[180px] pointer-events-none" />
                  ...
                  <button
                    ...
                    className={`transition-all duration-300 px-3 py-1.5 rounded-xl cursor-pointer ${
                      isSelected
                        ...
                        : isConnected
                        ? 'text-white border border-[#10b981]/50 bg-[#10b981]/10'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center border-t border-[#ffffff15] pt-10">
            <div className="lg:col-span-8 space-y-6">
              <div className="flex items-center gap-2">
                <span className="px-3 py-1 rounded-full bg-[#10b981]/20 text-[#10b981] border border-[#10b981]/40 text-[10px] font-mono tracking-widest uppercase">
              ...
              <div className="space-y-2">
                {currentRelation.connected.map((conn) => (
                  ...
                  >
                    ...
                    <span className="text-[#10b981] text-[10px] uppercase">Active Synergy</span>
                  </div>
                ))}
              </div>
            </div>
