...
export const TeamIndex: React.FC<TeamIndexProps> = ({ setCursorType }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 right-10 w-[600px] h-[600px] bg-[#ffffff]/[0.025] rounded-full blur-[180px] pointer-events-none" />
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-8 xl:gap-12">
                  <span className="font-mono text-xs text-[#888888] tracking-widest uppercase transition-transform duration-300 group-hover:translate-x-1 group-hover:text-[#ffffff]">
                    {member.number}
                  </span>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <span className="px-3 py-1 rounded-full text-[10px] font-mono tracking-widest uppercase border border-white/10 text-[#888888] group-hover:border-[#ffffff]/40 group-hover:text-[#ffffff] transition-colors">
                    {member.discipline}
                  </span>
                </div>
            ...
            {hoveredMember && (
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4 pointer-events-none">
                  <span className="text-[10px] font-mono uppercase tracking-widest text-[#ffffff] font-bold block">
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className={`p-1.5 rounded-full bg-white/5 text-white transition-transform duration-300 ${isExpanded ? 'rotate-180 bg-[#ffffff]' : ''}`}>
                    ...
                    >
                      <div className="p-5 pt-0 border-t border-white/5 space-y-6">
                        ...
                        <div className="flex items-center justify-between pt-2 text-xs font-mono text-[#888888]">
                          ...
                          <button
                            onClick={() => setSelectedMemberModal(member)}
                            className="inline-flex items-center gap-1 text-[#ffffff] hover:underline"
                          >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
                ...
                <div className="md:col-span-5 relative aspect-[3/4] md:aspect-auto min-h-[320px] bg-[#1a1a1f]">
                  ...
                  <div className="absolute top-5 left-5 px-3 py-1 rounded-full bg-black/70 backdrop-blur-md border border-white/15 text-[10px] font-mono uppercase tracking-widest text-[#ffffff]">
                ...
                <div className="md:col-span-7 p-6 sm:p-8 md:p-10 space-y-6 flex flex-col justify-between">
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm font-mono text-[#ffffff] uppercase tracking-wider mt-1">
                  ...
                  <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs font-mono uppercase tracking-widest text-[#ffffff] hover:underline"
                    >
