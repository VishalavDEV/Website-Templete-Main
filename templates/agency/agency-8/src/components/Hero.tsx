...
export const Hero: React.FC<HeroProps> = ({ onOpenProjectModal, setCursorType }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-[#10b981]/[0.05] rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full relative z-10 my-auto">
        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6 sm:space-y-8">
            ...
            >
              <div className="text-[10px] font-mono font-bold uppercase tracking-[0.4em] text-[#10b981] flex items-center gap-2">
            ...
            >
              <div className="w-px h-14 sm:h-16 bg-[#10b981] mt-1 shrink-0" />
            ...
            >
              <MagneticButton
                ...
                className="group inline-flex items-center gap-3 px-8 py-4 bg-[#10b981] text-white text-[11px] uppercase tracking-widest font-bold hover:brightness-110 cursor-pointer transition-all duration-300 shadow-[0_0_24px_rgba(0,102,255,0.35)]"
              >
      ...
      >
        ...
        >
          ...
          <div className="w-7 h-7 rounded-full border border-white/20 flex items-center justify-center group-hover:border-[#10b981] group-hover:bg-[#10b981]/10 transition-colors">
            <ArrowDown className="w-3.5 h-3.5 text-[#888888] group-hover:text-[#10b981] transition-transform group-hover:translate-y-0.5" />
          </div>
        </a>
      </motion.div>
    </section>
