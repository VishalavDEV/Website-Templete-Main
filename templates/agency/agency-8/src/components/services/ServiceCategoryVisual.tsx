...
export const ServiceCategoryVisual: React.FC<ServiceCategoryVisualProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-[#ffffff]/[0.03] rounded-full blur-[200px] pointer-events-none" />
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 relative z-10">
            ...
            <div className="space-y-6 border-l border-white/10 pl-6 group">
              <div className="w-12 h-12 rounded-lg bg-white/[0.03] border border-white/10 flex items-center justify-center text-[#ffffff]">
                <Compass className="w-6 h-6 group-hover:rotate-45 transition-transform duration-500" />
              </div>
              <div className="space-y-2">
                <span className="font-mono text-xs text-[#ffffff] uppercase tracking-widest block">
                  01 / FOUNDATION
                </span>
