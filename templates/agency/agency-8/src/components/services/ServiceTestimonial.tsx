    ...
    <section className="py-32 sm:py-48 border-t border-[#ffffff10] bg-[#080808] relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 text-center">
        ...
        <motion.div
          ...
          className="font-editorial text-7xl sm:text-9xl text-[#6366f1] leading-none mb-6 select-none opacity-80"
        >
          &ldquo;
        </motion.div>
        ...
        >
          ...
          <div className="font-mono text-xs uppercase tracking-[0.25em] text-[#6366f1] flex items-center justify-center gap-2">
            <span>CMO, AURA</span>
