  ...
  return (
    ...
    >
      ...
      {service.id === 'creative-technology' && (
        <div className="absolute top-1/2 right-1/4 w-[600px] h-[600px] bg-[#6366f1]/[0.04] rounded-full blur-[180px] pointer-events-none" />
      )}
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className={`space-y-8 ${isEven ? 'lg:col-span-6 lg:order-2' : 'lg:col-span-6'}`}>
            ...
            >
              <span className="text-[11px] font-mono uppercase tracking-[0.25em] text-[#6366f1] font-semibold block">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                {service.capabilities.map((cap) => (
                  <div
                    key={cap}
                    className="flex items-center gap-2.5 text-xs sm:text-sm font-mono text-[#FAF9F6]/90 bg-white/[0.02] border border-white/[0.08] px-3.5 py-2.5 rounded-sm hover:border-[#6366f1]/40 transition-colors"
                  >
