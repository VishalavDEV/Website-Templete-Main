              ...
              >
                ...
                >
                  <div className="relative aspect-[16/10] w-full rounded-xl overflow-hidden bg-[#111111] border border-white/10 shadow-2xl">
                    ...
                    {project.metrics && (
                      <div className="absolute top-6 right-6 px-3.5 py-1.5 bg-black/75 backdrop-blur-md rounded-full border border-white/15 text-xs font-mono text-[#6366f1] font-semibold">
                        {project.metrics}
                      </div>
                    )}
                  </div>
                ...
                >
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      onMouseLeave={() => setCursorType('default')}
                      className="group inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#FAF9F6] hover:text-[#6366f1] transition-colors font-semibold cursor-pointer"
                    >
                      <span>VIEW PROJECT DETAILS</span>
                      <ArrowUpRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 text-[#6366f1]" />
                    </button>
                  </div>
                </div>
              </motion.div>
