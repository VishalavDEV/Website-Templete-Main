...
export const ServicesHero: React.FC<ServicesHeroProps> = ({ setCursorType }) => {
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-between pt-32 sm:pt-40 pb-16 px-6 sm:px-8 lg:px-12 bg-[#080808] overflow-hidden border-b border-[#ffffff10]">
      ...
      <div className="absolute top-1/4 -right-20 w-[600px] h-[600px] bg-[#ffffff]/[0.035] rounded-full blur-[180px] pointer-events-none" />
      <div className="absolute -bottom-20 -left-20 w-[500px] h-[500px] bg-[#ffffff]/[0.02] rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="space-y-2 sm:space-y-3 mb-12 sm:mb-16">
          ...
          <div className="overflow-hidden">
            ...
            >
              <span>DESIGN</span>
              <span className="font-editorial italic font-normal text-[#ffffff] tracking-normal lowercase text-[0.92em]">
                &amp;
              </span>
            </motion.h1>
          </div>
