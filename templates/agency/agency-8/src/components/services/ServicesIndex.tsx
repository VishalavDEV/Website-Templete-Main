            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#ffffff] origin-top"
                />
                ...
                <div className="grid grid-cols-12 gap-6 items-center pl-6 lg:pl-10">
                  ...
                  <div className="col-span-1">
                    <span
                      className={`font-mono text-base lg:text-lg font-bold tracking-wider transition-colors duration-300 ${
                        isSelected ? 'text-[#ffffff]' : 'text-[#666666]'
                      }`}
                    >
                      {service.number}
                    </span>
                  ...
                  <div className="col-span-4 lg:col-span-5">
                    ...
                    <div className="mt-2 font-mono text-[10px] uppercase tracking-[0.2em] text-[#ffffff]/80">
                      {service.metadata}
                    </div>
                  </div>
                  ...
                  <div className="col-span-2 lg:col-span-2 flex justify-end">
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                      className="w-12 h-12 rounded-full border border-[#ffffff15] flex items-center justify-center text-[#FAF9F6] transition-colors group-hover:border-[#ffffff]"
                    >
              ...
              <div key={service.id} className="py-6">
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center text-white bg-white/5">
                    {isExpanded ? (
                      <Minus className="w-4 h-4 text-[#ffffff]" />
                    ) : (
                      ...
                      <div className="pt-5 space-y-5">
                        ...
                        <div className="pt-3">
                          <button
                            type="button"
                            onClick={() => handleItemClick(service)}
                            className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-[#ffffff] font-bold"
                          >
