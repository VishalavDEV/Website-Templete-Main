...
export const HowWeWorkSection: React.FC<HowWeWorkSectionProps> = ({ setCursorType }) => {
  ...
  return (
    <section className="py-32 sm:py-48 bg-[#080808] border-t border-[#ffffff10] relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-[#ffffff]/[0.025] rounded-full blur-[180px] pointer-events-none" />
            ...
            return (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                  <span className={`font-mono text-xs sm:text-sm font-bold ${isActive ? 'text-[#ffffff]' : ''}`}>
                    {step.number}
                  </span>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/[0.04] border border-white/10 rounded-full font-mono text-xs text-[#ffffff] uppercase tracking-wider">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-editorial italic text-xl text-[#ffffff]">
                    {activeStep.subtitle}
                  </p>
                </div>
              ...
              <div className="lg:col-span-7 space-y-4 lg:border-l lg:border-white/10 lg:pl-12">
                ...
                <div className="space-y-3 pt-2">
                  {activeStep.deliverables.map((item, idx) => (
                    <div
                      key={item}
                      className="flex items-center justify-between p-4 bg-white/[0.02] border border-white/[0.08] rounded-lg hover:border-[#ffffff]/30 transition-colors"
                    >
                      <div className="flex items-center gap-3">
                        <span className="font-mono text-xs text-[#ffffff]">
                          0{idx + 1}
                        </span>
