        ...
        <AnimatePresence mode="wait">
          {isBadgeMode ? (
            ...
            <motion.div
              ...
              className="px-4 py-2 rounded-full bg-[#6366f1] text-white font-mono font-bold text-[10px] sm:text-[11px] tracking-widest flex items-center gap-1.5 shadow-2xl border border-white/30 uppercase select-none shadow-[#6366f1]/40 backdrop-blur-md"
            >
              {cursorType === 'drag' ? (
            ...
            <motion.div
              ...
              className="w-0.5 h-5 bg-[#6366f1] rounded-full"
            />
          ) : isPointerOrButton ? (
            ...
            <motion.div
              ...
              className="w-7 h-7 rounded-full border border-[#6366f1] bg-[#6366f1]/20 flex items-center justify-center backdrop-blur-[2px]"
            >
              {cursorType === 'link' ? (
            ...
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.8 }}
              className="w-3.5 h-3.5 rounded-full border border-[#6366f1]/80 flex items-center justify-center"
            >
