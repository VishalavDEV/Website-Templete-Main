          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-6">
              <div className="relative aspect-[16/10] rounded-2xl overflow-hidden border border-white/15 bg-[#111115] shadow-2xl">
                ...
                <div className="absolute top-4 right-4 w-10 h-10 rounded-full bg-black/60 border border-white/20 flex items-center justify-center text-white backdrop-blur-md group-hover:rotate-45 group-hover:bg-[#6366f1] transition-all">
