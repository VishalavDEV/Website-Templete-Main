            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-6 sm:gap-10">
                  <span className="font-mono text-xs sm:text-sm text-[#888888] group-hover:text-[#10b981] transition-colors duration-300 w-8">
                    0{idx + 1}
                  </span>
                ...
                <div className="flex items-center justify-between md:justify-end gap-6 sm:gap-12 pl-14 md:pl-0">
                  <div className="text-left md:text-right space-y-0.5">
                    <span className="block text-xs sm:text-sm font-mono text-[#FAF9F6] font-medium group-hover:text-[#10b981] transition-colors">
                  ...
                  <div className="w-10 h-10 rounded-full border border-[#ffffff18] flex items-center justify-center group-hover:border-[#10b981] group-hover:bg-[#10b981] group-hover:text-white transition-all duration-300">
      ...
      {!isTouch && (
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-xs font-mono text-white pointer-events-none">
            ...
            <span className="text-[#10b981] font-semibold">{activeProject.categoryDisplay}</span>
          </div>
        </motion.div>
      )}
    </section>
