...
export const HorizontalProjects: React.FC<HorizontalProjectsProps> = ({
  ...
  return (
    <section className="py-24 sm:py-36 bg-[#060608] border-y border-[#ffffff10] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] bg-[#ffffff]/[0.025] rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div>
            ...
            <h2 className="font-display text-4xl sm:text-6xl lg:text-7xl font-bold text-[#FAF9F6] tracking-tight uppercase leading-[0.95]">
              A FEW<br />
              THINGS WE’RE<br />
              <span className="text-[#ffffff]">PROUD OF.</span>
            </h2>
          </div>
      ...
      >
        {spotlightProjects.map((project, idx) => (
          <motion.div
            ...
            onMouseLeave={() => setCursorType('default')}
            className="group relative flex-none w-[320px] sm:w-[420px] lg:w-[500px] snap-start cursor-pointer rounded-2xl overflow-hidden bg-[#0e0e12] border border-[#ffffff14] hover:border-[#ffffff]/60 transition-all duration-500 shadow-2xl select-none"
          >
            {/* Visual Container */}
            ...
            <div className="p-6 sm:p-8 space-y-3">
              <div className="flex items-center justify-between text-xs font-mono">
                <span className="text-[#ffffff] tracking-widest uppercase font-semibold">
                  {project.client}
                </span>
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="w-9 h-9 rounded-full border border-[#ffffff15] flex items-center justify-center group-hover:border-[#ffffff] group-hover:bg-[#ffffff]/10 transition-all duration-300">
                  <ArrowUpRight className="w-4 h-4 text-[#888888] group-hover:text-[#ffffff] group-hover:rotate-45 transition-transform" />
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mt-8">
        <div className="h-[2px] w-full bg-white/[0.08] rounded-full overflow-hidden">
          <div
            className="h-full bg-[#ffffff] transition-all duration-150 rounded-full"
