    ...
    <section className="py-16 sm:py-24 bg-[#080808] border-b border-[#ffffff10] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#ffffff10]">
          ...
          <div className="hidden sm:flex items-center gap-2 text-xs font-mono text-[#10b981] font-bold">
        ...
        <motion.div
          ...
          className="group relative cursor-pointer block rounded-3xl overflow-hidden bg-[#0e0e11] border border-[#ffffff18] hover:border-[#10b981]/60 transition-all duration-700 shadow-2xl"
        >
          ...
          <div className="relative aspect-[16/10] md:aspect-[21/10] w-full overflow-hidden">
            ...
            <div className="absolute top-6 sm:top-8 left-6 sm:left-8 right-6 sm:right-8 flex items-center justify-between pointer-events-none">
              ...
              {project.metrics && (
                <span className="px-4 py-1.5 bg-[#10b981] text-xs font-mono tracking-widest text-white uppercase font-bold shadow-lg shadow-[#10b981]/30">
                  {project.metrics}
                </span>
              )}
            </div>
            ...
            <div className="absolute bottom-6 sm:bottom-10 left-6 sm:left-10 right-6 sm:right-10 flex flex-col md:flex-row md:items-end justify-between gap-6 pointer-events-none">
              <div className="space-y-3 max-w-3xl">
                <div className="flex items-center gap-3">
                  <span className={`text-xs font-mono uppercase tracking-[0.3em] font-bold transition-colors duration-300 ${
                    isHovered ? 'text-[#10b981]' : 'text-white/80'
                  }`}>
                    {project.client}
                  </span>
              ...
              <div className="flex items-center gap-3 shrink-0">
                <div className="px-6 py-3.5 rounded-full bg-white text-black font-display font-bold text-xs uppercase tracking-widest flex items-center gap-2 group-hover:bg-[#10b981] group-hover:text-white transition-all duration-300 shadow-xl">
