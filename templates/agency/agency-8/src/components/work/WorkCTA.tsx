...
export const WorkCTA: React.FC<WorkCTAProps> = ({ onOpenProjectModal, setCursorType }) => {
  return (
    <section className="py-32 sm:py-48 bg-[#080808] relative overflow-hidden text-center">
      {/* Cinematic Aura */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#6366f1]/[0.05] rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 relative z-10 space-y-10">
        ...
        >
          YOUR PROJECT<br />
          COULD BE<br />
          <span className="text-[#6366f1]">NEXT.</span>
        </motion.h2>
