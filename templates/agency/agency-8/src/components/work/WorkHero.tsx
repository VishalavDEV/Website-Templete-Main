...
export const WorkHero: React.FC<WorkHeroProps> = ({ totalProjects, setCursorType }) => {
  ...
  return (
    <section className="relative min-h-[85vh] lg:min-h-[92vh] flex flex-col justify-between pt-36 sm:pt-44 pb-16 bg-[#080808] overflow-hidden border-b border-[#ffffff10]">
      ...
      <div className="absolute top-1/3 -left-48 w-[650px] h-[650px] bg-[#ffffff]/[0.035] rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute top-1/2 -right-48 w-[550px] h-[550px] bg-[#ffffff]/[0.025] rounded-full blur-[140px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <ArrowDown className="w-3.5 h-3.5 text-[#ffffff] animate-bounce" />
        </div>
      </motion.div>
    </section>
  );
