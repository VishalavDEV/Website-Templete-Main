...
export const WorkStatement: React.FC<WorkStatementProps> = ({ onNavigate, setCursorType }) => {
  return (
    <section className="py-28 sm:py-40 bg-[#080808] border-b border-[#ffffff10] relative overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#6366f1]/[0.025] rounded-full blur-[160px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              EVERY PROJECT<br />
              STARTS WITH<br />
              <span className="text-[#6366f1]">A PROBLEM.</span>
            </motion.h2>
          </div>
