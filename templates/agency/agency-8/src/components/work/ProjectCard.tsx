...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full rounded-2xl overflow-hidden bg-[#0d0d10] border border-[#ffffff14] hover:border-[#6366f1]/50 transition-all duration-500 shadow-xl">
        ...
        <div className={`relative w-full overflow-hidden ${getAspectClass()} bg-[#111114]`}>
          ...
          <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none z-10">
            ...
            {project.metrics && (
              <span className="px-3 py-1 bg-[#6366f1] text-[10px] font-mono tracking-widest text-white uppercase font-bold shadow-md shadow-[#6366f1]/20">
                {project.metrics}
              </span>
            )}
          </div>
        ...
        <div className="p-6 sm:p-8 flex flex-col justify-between grow space-y-4">
          <div className="space-y-2.5">
            <div className="flex items-center justify-between text-xs font-mono">
              <span className="text-[#888888] tracking-widest uppercase group-hover:text-[#6366f1] transition-colors duration-300 font-semibold">
                {project.client}
              </span>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="w-10 h-10 rounded-full border border-[#ffffff18] flex items-center justify-center group-hover:border-[#6366f1] group-hover:bg-[#6366f1]/10 transition-all duration-300 shrink-0">
                <ArrowUpRight className="w-4 h-4 text-[#888888] group-hover:text-[#6366f1] group-hover:rotate-45 transition-all duration-300" />
              </div>
            </div>
          ...
          <div className="pt-3 border-t border-[#ffffff0e] flex items-center justify-between gap-2 flex-wrap text-xs font-mono text-[#888888]">
            ...
            {project.award && (
              <div className="flex items-center gap-1 text-[10px] text-[#6366f1] shrink-0 font-medium">
