        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {WORK_CLIENTS.map((client, idx) => (
            <motion.div
              ...
              className="p-5 rounded-xl bg-white/[0.02] border border-[#ffffff0e] hover:border-[#ffffff]/40 hover:bg-white/[0.04] transition-all duration-300 flex flex-col items-center justify-center text-center gap-2 group cursor-default"
            >
              <span className="text-sm font-mono text-[#ffffff] group-hover:scale-110 transition-transform">
                {client.symbol}
              </span>
