...
export const SelectedWork: React.FC<SelectedWorkProps> = ({
  ...
  return (
    <section id="work" className="py-28 sm:py-36 bg-[#080808] relative overflow-hidden">
      ...
      <div className="absolute top-1/4 -left-32 w-[600px] h-[600px] bg-[#ffffff]/[0.02] rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-32 w-[600px] h-[600px] bg-[#ffffff]/[0.02] rounded-full blur-[150px] pointer-events-none" />
              ...
              >
                ...
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center ${
                  ...
                  <div className={`lg:col-span-8 ${isEven ? '' : 'lg:order-2'}`}>
                    <div className="relative overflow-hidden rounded-2xl bg-[#111111] border border-[#ffffff15] group-hover:border-[#ffffff]/40 transition-all duration-500 shadow-2xl">
                      ...
                      <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none">
                        ...
                        {project.metrics && (
                          <span className="px-3 py-1 bg-[#ffffff] text-[10px] font-mono tracking-widest text-white uppercase font-bold shadow-lg">
                            {project.metrics}
                          </span>
                        )}
                      </div>
                  ...
                  <div className={`lg:col-span-4 space-y-6 ${isEven ? '' : 'lg:order-1'}`}>
                    <div className="space-y-2">
                      <div className="flex items-center gap-3">
                        <span className="text-xs font-mono tracking-[0.2em] text-[#ffffff] uppercase font-bold">
                          {project.category}
                        </span>
                      ...
                      <div className="flex items-center justify-between group/title">
                        ...
                        <div className="w-12 h-12 rounded-full border border-[#ffffff15] flex items-center justify-center group-hover:border-[#ffffff] group-hover:bg-[#ffffff]/10 transition-all duration-300">
                          <ArrowUpRight className="w-5 h-5 text-[#888888] group-hover:text-[#ffffff] group-hover:rotate-45 transition-transform duration-300" />
                        </div>
                      </div>
                    </div>
                    ...
                    {project.awards && (
                      <div className="pt-2 flex items-center gap-2 text-xs font-mono text-[#888888]">
                        <Award className="w-3.5 h-3.5 text-[#ffffff] shrink-0" />
        ...
        {onNavigate && (
          <div className="mt-20 pt-12 border-t border-[#ffffff12] flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="space-y-1 text-center sm:text-left">
              <span className="font-mono text-xs text-[#ffffff] uppercase tracking-[0.25em] font-semibold block">
                FULL 2026 ARCHIVE
              </span>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
            ...
            >
              ...
              <div className="space-y-8">
                {/* Header */}
                <div>
                  <div className="flex items-center gap-3 text-xs font-mono text-[#ffffff] uppercase tracking-widest mb-2 font-bold">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-[#ffffff15]">
                  ...
                  <div className="space-y-4 bg-white/[0.02] p-5 rounded-xl border border-[#ffffff10]">
                    <h4 className="text-xs uppercase font-mono tracking-widest text-[#ffffff] font-bold">
                      Commercial Impact
                    </h4>
                ...
                <div className="pt-6 border-t border-[#ffffff15] flex items-center justify-between flex-wrap gap-4">
                  {onNavigate && (
                    <button
                      ...
                      className="px-6 py-3.5 bg-white text-black font-display font-bold text-xs uppercase tracking-wider flex items-center gap-2 hover:bg-[#ffffff] hover:text-white transition-all cursor-pointer rounded-full"
                    >
                  ...
                  <button
                    ...
                    className="px-6 py-3.5 bg-[#ffffff] text-white font-bold text-xs uppercase tracking-wider flex items-center gap-2 hover:brightness-110 transition-all cursor-pointer rounded-full"
                  >
