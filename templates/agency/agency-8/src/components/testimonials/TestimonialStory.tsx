        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pb-8 border-b border-[#ffffff10] mb-8 sm:mb-10 font-mono text-xs">
            ...
            <div className="space-y-1">
              ...
              <span className="text-sm text-[#ffffff] uppercase font-semibold block truncate">
                {story.project}
              </span>
            </div>
          </div>
          ...
          <div className="mb-8 sm:mb-10 space-y-4">
            <span className="text-[10px] font-mono uppercase tracking-widest text-[#ffffff] block">
              CORE PERSPECTIVE
            </span>
          ...
          <div className="pt-6 border-t border-[#ffffff10] flex flex-wrap items-center justify-between gap-4">
            <button
              ...
              onMouseEnter={() => setCursorType('pointer')}
              onMouseLeave={() => setCursorType('default')}
              className="group inline-flex items-center gap-2 px-6 py-4 bg-[#ffffff] hover:brightness-110 text-white font-mono text-xs uppercase tracking-widest font-bold transition-all cursor-pointer"
            >
