...
export const FeaturedTestimonial: React.FC<FeaturedTestimonialProps> = ({
  ...
  return (
    <section className="py-24 sm:py-36 px-6 sm:px-8 lg:px-12 bg-[#080808] border-b border-[#ffffff10] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[500px] h-[500px] bg-[#ffffff]/[0.025] rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 sm:space-y-10">
            <div className="space-y-4">
              <span className="font-mono text-[11px] uppercase tracking-widest text-[#ffffff] block">
            ...
            <div className="pt-6 border-t border-[#ffffff10] flex flex-wrap items-center justify-between gap-6">
              <div className="space-y-1">
                ...
                <p className="font-mono text-[11px] text-[#888888]">
                  PROJECT: <span className="text-[#ffffff]">AURA — BRAND EXPERIENCE</span>
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  onMouseEnter={() => setCursorType('pointer')}
                  onMouseLeave={() => setCursorType('default')}
                  className="group inline-flex items-center gap-2 px-5 py-3 rounded-none bg-[#ffffff] hover:brightness-110 text-white text-xs font-mono uppercase tracking-widest font-bold transition-all cursor-pointer"
                >
            ...
            <div className="relative group">
              ...
              <div className="relative aspect-[4/5] sm:aspect-[3/4] w-full overflow-hidden bg-[#111113] border border-white/10">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-[#080808]/90 backdrop-blur-md border border-white/10 flex items-center justify-between">
                  <div>
                    <span className="font-mono text-[10px] uppercase tracking-widest text-[#ffffff] block">
