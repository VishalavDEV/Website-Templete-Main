          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="font-mono text-[9px] uppercase tracking-widest text-[#10b981]">
          ...
          {CLIENT_STORIES.map((story, index) => {
            ...
            return (
              <div
                ...
                className={`group relative py-8 sm:py-10 px-4 sm:px-6 transition-all duration-300 cursor-pointer outline-none focus-visible:ring-1 focus-visible:ring-[#10b981] ${
              ...
              >
                ...
                <div 
                  className={`absolute left-0 top-0 bottom-0 w-[2px] bg-[#10b981] transition-transform duration-300 origin-center ${
