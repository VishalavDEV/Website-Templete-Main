          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="font-mono text-[9px] uppercase tracking-widest text-[#ffffff]">
          ...
          {CLIENT_STORIES.map((story, index) => {
            ...
            return (
              <div
                ...
                className={`group relative py-8 sm:py-10 px-4 sm:px-6 transition-all duration-300 cursor-pointer outline-none focus-visible:ring-1 focus-visible:ring-[#ffffff] ${
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 items-center">
                  ...
                  <div className="md:col-span-4 flex items-baseline gap-6">
                    <span className="font-mono text-xs text-[#888888] group-hover:text-[#ffffff] transition-colors">
                      {formattedIndex}
                    </span>
                  ...
                  <div className="md:col-span-1 flex items-center justify-end">
                    <div className="w-10 h-10 rounded-full border border-white/10 group-hover:border-[#ffffff] group-hover:bg-[#ffffff] flex items-center justify-center text-white/50 group-hover:text-white transition-all duration-300">
                ...
                <div 
                  className={`absolute left-0 top-0 bottom-0 w-[2px] bg-[#ffffff] transition-transform duration-300 origin-center ${
