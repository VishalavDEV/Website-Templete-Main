...
export const AboutPreview: React.FC<AboutPreviewProps> = ({
  ...
  return (
    <section id="about" className="py-28 sm:py-36 relative overflow-hidden bg-[#080808]">
      {/* Background accents */}
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-[#6366f1]/[0.02] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="space-y-12 lg:space-y-16">
          ...
          >
            ...
            <span className="font-editorial italic font-normal text-[#6366f1] lowercase">
            ...
            >
              ...
              <div className="pt-4">
                <MagneticButton
                  ...
                  className="group inline-flex items-center gap-2.5 text-xs font-semibold uppercase tracking-[0.2em] text-[#FAF9F6] hover:text-[#6366f1] transition-colors py-2 cursor-pointer"
                >
                  <span>More About Us</span>
                  <span className="text-sm text-[#6366f1] transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">&nearr;</span>
                </MagneticButton>
              </div>
            </motion.div>
            ...
            >
              {pillars.map((pillar, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-6 rounded-xl bg-white/[0.02] border border-[#ffffff10] hover:border-[#6366f1]/40 transition-colors group"
                  >
                    <div className="flex items-center gap-3.5 mb-2">
                      <div className="p-2 rounded-lg bg-[#6366f1]/10 text-[#6366f1] group-hover:bg-[#6366f1]/20 transition-colors">
