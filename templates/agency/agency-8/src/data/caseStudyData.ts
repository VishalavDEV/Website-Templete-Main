  ...
  aura: {
    ...
    creativeDirection: {
      ...
      colors: [
        ...
        { name: 'Aura Electric', hex: '#ffffff', role: 'Primary Luminescence' },
  ...
  north: {
    ...
    creativeDirection: {
      ...
      colors: [
        ...
        { name: 'Emerald Bid', hex: '#ffffff', role: 'Positive Alpha' },
  ...
  return {
    ...
    creativeDirection: {
      ...
      colors: [
        ...
        { name: 'Signature Accent', hex: found.accent || '#ffffff', role: 'Primary Focus' },
