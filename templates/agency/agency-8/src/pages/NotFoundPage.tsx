    ...
    <section className="min-h-[85vh] flex items-center justify-center relative px-6 sm:px-12 py-24 bg-[#080808]">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.div
          ...
          className="font-display font-black text-8xl sm:text-9xl md:text-[12rem] text-[#ffffff]/20 select-none tracking-tighter"
        >
          404
        </motion.div>
        ...
        >
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#ffffff] text-white font-mono text-xs uppercase tracking-widest font-bold hover:brightness-110 transition-all shadow-lg shadow-[#ffffff]/30 cursor-pointer"
          >
