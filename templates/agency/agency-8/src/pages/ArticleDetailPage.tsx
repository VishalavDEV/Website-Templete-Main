    ...
    return (
      <div className="min-h-screen bg-[#080808] text-[#FAF9F6] pt-36 pb-24 px-6 sm:px-8 flex items-center justify-center">
        <div className="max-w-xl text-center space-y-8">
          <div className="w-16 h-16 rounded-full bg-white/[0.04] border border-white/10 flex items-center justify-center mx-auto text-[#6366f1]">
          ...
          <div className="pt-4">
            <button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#6366f1] hover:brightness-110 text-white font-mono text-xs uppercase tracking-widest font-bold border border-[#6366f1]/40 transition-all cursor-pointer shadow-lg shadow-[#6366f1]/10"
            >
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-28 sm:pt-32">
        <button
          ...
          onMouseLeave={() => setCursorType('default')}
          className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-[#888888] hover:text-[#6366f1] transition-colors cursor-pointer group"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 space-y-16">
            ...
            <div className="space-y-6">
              <p className="font-body text-xl sm:text-2xl md:text-3xl text-[#FAF9F6] font-normal leading-relaxed border-l-2 border-[#6366f1] pl-6 py-1">
          ...
          <aside className="lg:col-span-3 space-y-8 lg:sticky lg:top-32">
            ...
            <div className="p-6 bg-white/[0.02] border border-white/10 space-y-4">
              <span className="font-mono text-[10px] uppercase tracking-widest text-[#6366f1] font-semibold block">
                CITATION NOTE
              </span>
